...
+ (NSString *)exitCacheTemporaryWithUrl:(NSArray *)urls {
    NSString * cacheUrl = @"";
    if (urls.count != 0) {
        for (NSString * url in urls) {
            NSString * path = [NSString stringWithFormat:@"%@/%@",[ZBLM3u8Setting downloadTemporaryPath],[ZBLM3u8Setting uuidWithUrl:url]];
