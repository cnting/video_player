...
-(void)download:(FLTDownloadMessage*)input error:(FlutterError *_Nullable *_Nonnull)error;
-(void)removeDownload:(FLTTextureMessage*)input error:(FlutterError *_Nullable *_Nonnull)error;
@end
