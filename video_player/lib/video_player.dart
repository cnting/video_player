...
export 'package:video_player_platform_interface/video_player_platform_interface.dart'
    show DurationRange, DataSourceType, VideoFormat, VideoPlayerOptions, DownloadState;
...
class VideoPlayerController extends ValueNotifier<VideoPlayerValue> {
    ...
    void eventListener(VideoEvent event) {
      ...
      switch (event.eventType) {
        ...
        case VideoEventType.unknown:
          break;
        case VideoEventType.downloadState:
          downloadNotifier.value = event.downloadState;
          break;
      }
    }
  ...
  void download(String showName) {
    _videoPlayerPlatform.download(_textureId, 0, showName);
  }

  void removeDownload() {
    _videoPlayerPlatform.removeDownload(_textureId);
  }
